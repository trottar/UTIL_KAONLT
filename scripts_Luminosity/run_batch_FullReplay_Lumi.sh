...
inputFile="/group/c-kaonlt/USERS/${USER}/hallc_replay_lt/UTIL_KAONLT/scripts_Luminosity/inputRuns" 
...
while true; do
    ...
    case $yn in
		...
		#echo "TIME: 1" >> ${batch} 
		echo "COMMAND:/group/c-kaonlt/USERS/${USER}/hallc_replay_lt/UTIL_KAONLT/scripts_Luminosity/FullReplay_Batch.sh ${runNum}" >> ${batch}                                                        
