...
void hms_cer_efficiency::SlaveBegin(TTree * /*tree*/)
{
  ...
  h2ROC1_Coin_Beta_noID_electron = new TH2F("ROC1_Coin_Beta_noCut_electron","Electron Coincident Time vs Mass (GeV/c^{2}) for ROC1 (w/ particle ID);Time (ns);Mass (GeV/c^{2})",800,-40,40,200,0.0,2.0);
  h2ROC1_Coin_Beta_electron = new TH2F("ROC1_Coin_Beta_electron","Electron Coincident Time vs Mass (GeV/c^{2}) for ROC1 (w/ particle ID);Time (ns);Mass (GeV/c^{2})",800,-40,40,200,0.0,2.0);
...
Bool_t hms_cer_efficiency::Process(Long64_t entry)
{
  ...
  h2ROC1_Coin_Beta_noID_electron->Fill((CTime_ePositronCoinTime_ROC1[0] - 43),sqrt(pow(emiss[0],2)-pow(pmiss[0],2)));
  ...
  h2ROC1_Coin_Beta_electron->Fill((CTime_ePositronCoinTime_ROC1[0] - 43),sqrt(pow(emiss[0],2)-pow(pmiss[0],2)));
