...
void hms_cer_efficiency::SlaveBegin(TTree * /*tree*/)
{
  ...
  h2ROC1_Coin_Beta_noID_electron = new TH2F("ROC1_Coin_Beta_noCut_electron","Electron Coincident Time vs Mass (GeV/c^{2}) for ROC1 (w/ particle ID);Mass (GeV/c^{2})",200,0.0,2.0,50,0.1,10);
  h2ROC1_Coin_Beta_electron = new TH2F("ROC1_Coin_Beta_electron","Electron Coincident Time vs Mass (GeV/c^{2}) for ROC1 (w/ particle ID);Mass (GeV/c^{2})",200,0.0,2.0,50,0.1,10);
