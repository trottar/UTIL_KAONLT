#define shms_cer_efficiency_cxx
// The class definition in shms_cer_efficiency.h has been generated automatically
...
//
// root> T->Process("shms_cer_efficiency.C")
// root> T->Process("shms_cer_efficiency.C","some options")
// root> T->Process("shms_cer_efficiency.C+")
//


#include "shms_cer_efficiency.h"
#include <TStyle.h>
#include <TCanvas.h>
#include <TLine.h>
#include <TMath.h>
...
void shms_cer_efficiency::Begin(TTree * /*tree*/)
{
...
void shms_cer_efficiency::SlaveBegin(TTree * /*tree*/)
{
...
Bool_t shms_cer_efficiency::Process(Long64_t entry)
{
  ...
  if(P_cal_etotnorm[0] > 0.7 || P_aero_npeSum[0] > 17.0){
...
void shms_cer_efficiency::SlaveTerminate()
{
...
void shms_cer_efficiency::Terminate()
{
