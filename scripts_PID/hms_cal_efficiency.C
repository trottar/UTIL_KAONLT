#define hms_cal_efficiency_cxx
// The class definition in hms_cal_efficiency.h has been generated automatically
...
//
// root> T->Process("hms_cal_efficiency.C")
// root> T->Process("hms_cal_efficiency.C","some options")
// root> T->Process("hms_cal_efficiency.C+")
//


#include "hms_cal_efficiency.h"
#include <TStyle.h>
#include <TCanvas.h>
#include <TLine.h>
#include <TMath.h>
...
void hms_cal_efficiency::Begin(TTree * /*tree*/)
{
...
void hms_cal_efficiency::SlaveBegin(TTree * /*tree*/)
{
...
Bool_t hms_cal_efficiency::Process(Long64_t entry)
{
...
void hms_cal_efficiency::SlaveTerminate()
{
...
void hms_cal_efficiency::Terminate()
{
