...
SKIMPATH=lt.SetPath(CURRENT_ENV).getPath("SKIMPATH")
...
BashPathEntry=("%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s" % (VOLATILEPATH,ANALYSISPATH,HCANAPATH, REPLAYPATH, UTILPATH, PACKAGEPATH, OUTPATH, ROOTPATH, SKIMPATH, REPORTPATH, CUTPATH, PARAMPATH, SCRIPTPATH, ANATYPE, USER, HOST, SIMCPATH, LTANAPATH, CACHEPATH))
print(BashPathEntry)
