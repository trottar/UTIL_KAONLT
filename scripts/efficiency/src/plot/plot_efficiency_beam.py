...
# Description:
# ================================================================
# Time-stamp: "2023-12-19 22:22:44 trottar"
# ================================================================
#
...
def fit_data(plt, x_name, y_name):
    ...
    plt.errorbar(x_data, y_data, yerr=y_error, color='black',linestyle='None',zorder=3)
...
plt.scatter(efficiency_data_8p2["BCM1_Beam_Cut_Current"],efficiency_data_8p2["HMS_Hodo_3_of_4_EFF"],color='green',zorder=4,label='8p2')
plt.legend(loc="lower right", markerscale=0.7, scatterpoints=1, fontsize=10)
plt.ylabel('HMS_Hodo_3_of_4_EFF', fontsize=12)
plt.xlabel('Current', fontsize=12)
plt.title('HMS %s-%s' % (int(min(efficiency_data["Run_Number"])),int(max(efficiency_data["Run_Number"]))), fontsize=12)
...
plt.scatter(efficiency_data_8p2["BCM1_Beam_Cut_Current"],efficiency_data_8p2["HMS_Cal_ALL_Elec_Eff"],color='green',zorder=4,label='8p2')
plt.legend(loc="lower right", markerscale=0.7, scatterpoints=1, fontsize=10)
...
plt.scatter(efficiency_data_8p2["BCM1_Beam_Cut_Current"],efficiency_data_8p2["HMS_Cer_ALL_Elec_Eff"],color='green',zorder=4,label='8p2')
plt.legend(loc="lower right", markerscale=0.7, scatterpoints=1, fontsize=10)
...
plt.scatter(efficiency_data_8p2["BCM1_Beam_Cut_Current"],efficiency_data_8p2["SHMS_Aero_All_Pion_Eff"],color='green',zorder=4,label='8p2')
plt.legend(loc="lower right", markerscale=0.7, scatterpoints=1, fontsize=10)
