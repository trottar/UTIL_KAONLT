...
plt.scatter(efficiency_data_8p2["SHMS_3/4_Trigger_Rate"],efficiency_data_8p2["SHMS_Pion_ALL_TRACK_EFF"],color='green',zorder=4,label='8p2')
plt.legend(loc="lower right", markerscale=0.7, scatterpoints=1, fontsize=10)
...
plt.scatter(efficiency_data_8p2["SHMS_3/4_Trigger_Rate"],efficiency_data_8p2["SHMS_Aero_ALL_Pion_Eff"],color='green',zorder=4,label='8p2')
plt.legend(loc="lower right", markerscale=0.7, scatterpoints=1, fontsize=10)
...
plt.scatter(efficiency_data_8p2["SHMS_Hodoscope_S1X_Rate"],efficiency_data_8p2["SHMS_Pion_ALL_TRACK_EFF"],color='green',zorder=4,label='8p2')
plt.legend(loc="lower right", markerscale=0.7, scatterpoints=1, fontsize=10)
plt.ylabel('SHMS_Pion_ALL_TRACK_EFF', fontsize=12)
plt.xlabel('SHMS S1X HODO Rate [kHz]', fontsize=12)
plt.title('SHMS %s-%s' % (int(min(efficiency_data["Run_Number"])),int(max(efficiency_data["Run_Number"]))), fontsize=12)
...
plt.scatter(efficiency_data_8p2["SHMS_Hodoscope_S1X_Rate"],efficiency_data_8p2["SHMS_Aero_ALL_Pion_Eff"],color='green',zorder=4,label='8p2')
plt.legend(loc="lower right", markerscale=0.7, scatterpoints=1, fontsize=10)
plt.ylabel('SHMS_Aero_ALL_Pion_Eff', fontsize=12)
plt.xlabel('SHMS S1X HODO Rate [kHz]', fontsize=12)
plt.title('SHMS %s-%s' % (int(min(efficiency_data["Run_Number"])),int(max(efficiency_data["Run_Number"]))), fontsize=12)
...
plt.scatter(efficiency_data_8p2["HMS_EL-REAL_Trigger_Rate"],efficiency_data_8p2["HMS_Elec_ALL_TRACK_EFF"],color='green',zorder=4,label='8p2')
plt.legend(loc="lower right", markerscale=0.7, scatterpoints=1, fontsize=10)
...
plt.scatter(efficiency_data_8p2["HMS_EL-REAL_Trigger_Rate"],efficiency_data_8p2["HMS_Cer_ALL_Elec_Eff"],color='green',zorder=4,label='8p2')
plt.legend(loc="lower right", markerscale=0.7, scatterpoints=1, fontsize=10)
...
plt.scatter(efficiency_data_8p2["HMS_Hodoscope_S1X_Rate"],efficiency_data_8p2["HMS_Elec_ALL_TRACK_EFF"],color='green',zorder=4,label='8p2')
plt.legend(loc="lower right", markerscale=0.7, scatterpoints=1, fontsize=10)
plt.ylabel('HMS_Elec_ALL_TRACK_EFF', fontsize=12)
plt.xlabel('HMS S1X HODO Rate [kHz]', fontsize=12)
plt.title('HMS %s-%s' % (int(min(efficiency_data["Run_Number"])),int(max(efficiency_data["Run_Number"]))), fontsize=12)
...
plt.scatter(efficiency_data_8p2["HMS_Hodoscope_S1X_Rate"],efficiency_data_8p2["HMS_Cer_ALL_Elec_Eff"],color='green',zorder=4,label='8p2')
plt.legend(loc="lower right", markerscale=0.7, scatterpoints=1, fontsize=10)
plt.ylabel('HMS_Cer_ALL_Elec_Eff', fontsize=12)
plt.xlabel('HMS S1X HODO Rate [kHz]', fontsize=12)
plt.title('HMS %s-%s' % (int(min(efficiency_data["Run_Number"])),int(max(efficiency_data["Run_Number"]))), fontsize=12)
...
plt.scatter(efficiency_data_8p2["Run_Number"],efficiency_data_8p2["SHMS_Pion_ALL_TRACK_EFF"],color='green',zorder=4,label='8p2')
plt.legend(loc="lower right", markerscale=0.7, scatterpoints=1, fontsize=10)
plt.ylabel('SHMS_Pion_ALL_TRACK_EFF', fontsize=12)
plt.xlabel('Run Number', fontsize=12)
plt.title('SHMS %s-%s' % (int(min(efficiency_data["Run_Number"])),int(max(efficiency_data["Run_Number"]))), fontsize=12)
...
plt.scatter(efficiency_data_8p2["Run_Number"],efficiency_data_8p2["SHMS_Aero_ALL_Pion_Eff"],color='green',zorder=4,label='8p2')
plt.legend(loc="lower right", markerscale=0.7, scatterpoints=1, fontsize=10)
plt.ylabel('SHMS_Aero_ALL_Pion_Eff', fontsize=12)
plt.xlabel('Run Number', fontsize=12)
plt.title('SHMS %s-%s' % (int(min(efficiency_data["Run_Number"])),int(max(efficiency_data["Run_Number"]))), fontsize=12)
...
plt.scatter(efficiency_data_8p2["Run_Number"],efficiency_data_8p2["HMS_Elec_ALL_TRACK_EFF"],color='green',zorder=4,label='8p2')
plt.legend(loc="lower right", markerscale=0.7, scatterpoints=1, fontsize=10)
plt.ylabel('HMS_Elec_ALL_TRACK_EFF', fontsize=12)
plt.xlabel('Run Number', fontsize=12)
plt.title('HMS %s-%s' % (int(min(efficiency_data["Run_Number"])),int(max(efficiency_data["Run_Number"]))), fontsize=12)
...
plt.scatter(efficiency_data_8p2["Run_Number"],efficiency_data_8p2["HMS_Cer_ALL_Elec_Eff"],color='green',zorder=4,label='8p2')
plt.legend(loc="lower right", markerscale=0.7, scatterpoints=1, fontsize=10)
plt.ylabel('HMS_Cer_ALL_Elec_Eff', fontsize=12)
plt.xlabel('Run Number', fontsize=12)
plt.title('HMS %s-%s' % (int(min(efficiency_data["Run_Number"])),int(max(efficiency_data["Run_Number"]))), fontsize=12)
