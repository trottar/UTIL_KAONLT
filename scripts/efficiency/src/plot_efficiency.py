...
# Description:
# ================================================================
# Time-stamp: "2022-06-09 06:15:16 trottar"
# ================================================================
#
...
plt.ylabel('EDTM', fontsize=14)
plt.xlabel('SHMS 3/4 Trigger Rate [kHz]', fontsize =14)
plt.title('SHMS %s-%s' % (int(min(efficiency_data["Run_Number"])),int(max(efficiency_data["Run_Number"]))), fontsize =14)
...
plt.ylabel('SHMS_Pion_SING_TRACK_EFF', fontsize=14)
plt.xlabel('SHMS 3/4 Trigger Rate [kHz]', fontsize =14)
plt.title('SHMS %s-%s' % (int(min(efficiency_data["Run_Number"])),int(max(efficiency_data["Run_Number"]))), fontsize =14)
...
plt.ylabel('SHMS_Aero_SING_Pion_Eff', fontsize=14)
plt.xlabel('SHMS 3/4 Trigger Rate [kHz]', fontsize =14)
plt.title('SHMS %s-%s' % (int(min(efficiency_data["Run_Number"])),int(max(efficiency_data["Run_Number"]))), fontsize =14)
...
plt.ylabel('SHMS_Hodo_3_of_4_EFF', fontsize=14)
plt.xlabel('SHMS 3/4 Trigger Rate [kHz]', fontsize =14)
plt.title('SHMS %s-%s' % (int(min(efficiency_data["Run_Number"])),int(max(efficiency_data["Run_Number"]))), fontsize =14)
...
plt.ylabel('EDTM', fontsize=14)
plt.xlabel('HMS EL-REAL Trigger Rate [kHz]', fontsize =14)
plt.title('HMS %s-%s' % (int(min(efficiency_data["Run_Number"])),int(max(efficiency_data["Run_Number"]))), fontsize =14)
...
plt.ylabel('HMS_Elec_SING_TRACK_EFF', fontsize=14)
plt.xlabel('HMS EL-REAL Trigger Rate [kHz]', fontsize =14)
plt.title('HMS %s-%s' % (int(min(efficiency_data["Run_Number"])),int(max(efficiency_data["Run_Number"]))), fontsize =14)
...
plt.ylabel('HMS_Cer_SING_Elec_Eff', fontsize=14)
plt.xlabel('HMS EL-REAL Trigger Rate [kHz]', fontsize =14)
plt.title('HMS %s-%s' % (int(min(efficiency_data["Run_Number"])),int(max(efficiency_data["Run_Number"]))), fontsize =14)
...
plt.ylabel('HMS_Hodo_3_of_4_EFF', fontsize=14)
plt.xlabel('HMS EL-REAL Trigger Rate [kHz]', fontsize =14)
plt.title('HMS %s-%s' % (int(min(efficiency_data["Run_Number"])),int(max(efficiency_data["Run_Number"]))), fontsize =14)
...
plt.ylabel('EDTM', fontsize=14)
plt.xlabel('HMS S1X HODO Rate [kHz]', fontsize =14)
plt.title('HMS %s-%s' % (int(min(efficiency_data["Run_Number"])),int(max(efficiency_data["Run_Number"]))), fontsize =14)
...
plt.ylabel('EDTM', fontsize=14)
plt.xlabel('COIN Trigger Rate [kHz]', fontsize =14)
plt.title('COIN %s-%s' % (int(min(efficiency_data["Run_Number"])),int(max(efficiency_data["Run_Number"]))), fontsize =14)
...
plt.ylabel('SHMS 3/4 Trigger Rate [kHz]', fontsize =14)
plt.xlabel('COIN Trigger Rate [kHz]', fontsize=14)
plt.title('SHMS %s-%s' % (int(min(efficiency_data["Run_Number"])),int(max(efficiency_data["Run_Number"]))), fontsize =14)
...
plt.ylabel('HMS EL-REAL Trigger Rate [kHz]', fontsize =14)
plt.xlabel('COIN Trigger Rate [kHz]', fontsize=14)
plt.title('HMS %s-%s' % (int(min(efficiency_data["Run_Number"])),int(max(efficiency_data["Run_Number"]))), fontsize =14)
