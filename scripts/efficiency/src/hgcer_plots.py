...
# Description:
# ================================================================
# Time-stamp: "2022-06-15 18:10:24 trottar"
# ================================================================
# 
...
for evt in Events_no_cal_hgc_cuts:
  h2_events_no_cal_hgc_cuts.Fill(evt.P_no_cal_hgc_etot, evt.P_no_cal_hgc_cuts_hgcer_npeSum);
...
for evt in Events_no_cal_hgc_aero_cuts:
    h2_events_no_cal_hgc_aero_cuts.Fill(evt.P_no_cal_hgc_aero_cuts_hgcer_npeSum, evt.P_no_cal_hgc_aero_cuts_aero_npeSum);
    h2_events_no_cal_aero_cuts.Fill(evt.P_no_cal_hgc_aero_cuts_etot, evt.P_no_cal_hgc_aero_cuts_aero_npeSum);
    h3_events_no_cal_aero_cuts.Fill(evt.P_no_cal_hgc_aero_cuts_aero_xAtCer, evt.P_no_cal_hgc_aero_cuts_aero_yAtCer, evt.P_no_cal_hgc_aero_cuts_aero_npeSum);   
...
for evt in Pions:
    #2-D Histograms
    h3_Pions_XyAtCer_NPE.Fill(evt.Pions_xAtCer, evt.Pions_yAtCer, evt.Pions_SHMS_hgcer_npeSum);
    h2_Pions_Cal_Showers.Fill(evt.Pions_Cal_Shower/Pions_gtr_p, evt.Pions_Cal_Pr_Shower/evt.Pions_gtr_p);
    h2_Pions_XYgtr.Fill(evt.Pions_SHMS_gtr_x, evt.Pions_SHMS_gtr_y);
    h2_Pions_XyAtCer.Fill(evt.Pions_yAtCer, evt.Pions_xAtCer);
    h2_Pions_npeSum.Fill(evt.Pions_SHMS_hgcer_npeSum, evt.Pions_SHMS_aero_npeSum);
    # 1-D Histograms
    h1_Pions_hgcer_npeSum.Fill(evt.Pions_SHMS_hgcer_npeSum);
    h1_Pions_aero_npeSum.Fill(evt.Pions_SHMS_aero_npeSum);     
    h1_Pions_xAtCer.Fill(evt.Pions_xAtCer);
    h1_Pions_yAtCer.Fill(evt.Pions_yAtCer);
    h1_Pions_Prshower.Fill(evt.Pions_Cal_Pr_Shower/evt.Pions_gtr_p);
    h1_Pions_Shower.Fill(evt.Pions_Cal_Shower/evt.Pions_gtr_p);
    h1_Pions_Xgtr.Fill(evt.Pions_SHMS_gtr_x);
    h1_Pions_Ygtr.Fill(evt.Pions_SHMS_gtr_y);
    h1_Pions_gtr_beta.Fill(evt.Pions_gtr_beta);    
    h1_Pions_gtr_p.Fill(evt.Pions_gtr_p);
    h1_Pions_gtr_dp.Fill(evt.Pions_gtr_dp);
    h1_Pions_gtr_xp.Fill(evt.Pions_gtr_xp);
    h1_Pions_gtr_yp.Fill(evt.Pions_gtr_yp);
    h1_Pions_P_etot.Fill(evt.Pions_P_cal_etot);  
    h1_Pions_CTime_ePi_ROC1.Fill(evt.Pions_CTime_ePi_ROC1);
...
for evt in Positrons:
    #2-D Histograms
    h2_Positrons_XyAtCer.Fill(evt.Positrons_yAtCer, evt.Positrons_xAtCer);
    h2_Positrons_Cal_Showers.Fill(evt.Positrons_Cal_Shower/evt.Positrons_gtr_p, evt.Positrons_Cal_Pr_Shower/evt.Positrons_gtr_p);
    h2_Positrons_XYgtr.Fill(evt.Positrons_SHMS_gtr_x, evt.Positrons_SHMS_gtr_y);
    # 1-D Histograms
    h1_Positrons_hgcer_npeSum.Fill(evt.Positrons_SHMS_hgcer_npeSum);
    h1_Positrons_aero_npeSum.Fill(evt.Positrons_SHMS_aero_npeSum);     
    h1_Positrons_xAtCer.Fill(evt.Positrons_xAtCer);
    h1_Positrons_yAtCer.Fill(evt.Positrons_yAtCer);
    h1_Positrons_Prshower.Fill(evt.Positrons_Cal_Pr_Shower/evt.Positrons_gtr_p);
    h1_Positrons_Shower.Fill(evt.Positrons_Cal_Shower/evt.Positrons_gtr_p);
    h1_Positrons_Xgtr.Fill(evt.Positrons_SHMS_gtr_x);
    h1_Positrons_Ygtr.Fill(evt.Positrons_SHMS_gtr_y);
    h1_Positrons_gtr_beta.Fill(evt.Positrons_gtr_beta);    
    h1_Positrons_gtr_p.Fill(evt.Positrons_gtr_p);
    h1_Positrons_gtr_dp.Fill(evt.Positrons_gtr_dp);
    h1_Positrons_gtr_xp.Fill(evt.Positrons_gtr_xp);
    h1_Positrons_gtr_yp.Fill(evt.Positrons_gtr_yp);
    h1_Positrons_P_etot.Fill(evt.Positrons_P_cal_etot);  
    # h1_Pions_CTime_ePi_ROC1.Fill(evt.Pions_CTime_ePi_ROC1);
...
for evt in Kaons:
    h2_Kaons_XyAtCer.Fill(evt.Kaons_yAtCer, evt.Kaons_xAtCer);
    h2_Kaons_Cal_Showers.Fill(evt.Kaons_Cal_Shower/6.053, evt.Kaons_Cal_Pr_Shower/6.053);
    h2_Kaons_XYgtr.Fill(evt.Kaons_SHMS_gtr_x, evt.Kaons_SHMS_gtr_y);
    h1_Kaons_hgcer_npeSum.Fill(evt.Kaons_SHMS_hgcer_npeSum);
...
for evt in Protons:
    h2_Protons_XyAtCer.Fill(evt.Protons_yAtCer, evt.Protons_xAtCer);
    h2_Protons_Cal_Showers.Fill(evt.Protons_Cal_Shower, evt.Protons_Cal_Pr_Shower);
    h2_Protons_XYgtr.Fill(evt.Protons_SHMS_gtr_x, evt.Protons_SHMS_gtr_y);
    h1_Protons_hgcer_npeSum.Fill(evt.Protons_SHMS_hgcer_npeSum);
...
for evt in Pions_No_HGC_Cuts:
    #2-D Histograms
    h3_Pi_XyAtCer_NPE.Fill(evt.Pions_No_HGC_Cuts_xAtCer, evt.Pions_No_HGC_Cuts_yAtCer,  evt.Pions_No_HGC_Cuts_SHMS_hgcer_npeSum);
    h2_Pi_Cal_Showers.Fill(evt.Pions_No_HGC_Cuts_Cal_Shower/evt.Pions_No_HGC_Cuts_gtr_p, evt.Pions_No_HGC_Cuts_Cal_Pr_Shower/evt.Pions_No_HGC_Cuts_gtr_p);
    h2_Pi_XYgtr.Fill(evt.Pions_No_HGC_Cuts_SHMS_gtr_x, evt.Pions_No_HGC_Cuts_SHMS_gtr_y);
    h2_Pi_XyAtCer.Fill(evt.Pions_No_HGC_Cuts_yAtCer, evt.Pions_No_HGC_Cuts_xAtCer);
    # 1-D Histograms
    h1_Pi_hgcer_npeSum.Fill(evt.Pions_No_HGC_Cuts_SHMS_hgcer_npeSum);
    h1_Pi_aero_npeSum.Fill(evt.Pions_No_HGC_Cuts_SHMS_aero_npeSum);     
    h1_Pi_xAtCer.Fill(evt.Pions_No_HGC_Cuts_xAtCer);
    h1_Pi_yAtCer.Fill(evt.Pions_No_HGC_Cuts_yAtCer);
    h1_Pi_Prshower.Fill(evt.Pions_No_HGC_Cuts_Cal_Pr_Shower/evt.Pions_No_HGC_Cuts_gtr_p);
    h1_Pi_Shower.Fill(evt.Pions_No_HGC_Cuts_Cal_Shower/evt.Pions_No_HGC_Cuts_gtr_p);
    h1_Pi_Xgtr.Fill(evt.Pions_No_HGC_Cuts_SHMS_gtr_x);
    h1_Pi_Ygtr.Fill(evt.Pions_No_HGC_Cuts_SHMS_gtr_y);
    h1_Pi_gtr_beta.Fill(evt.Pions_No_HGC_Cuts_gtr_beta);    
    h1_Pi_gtr_p.Fill(evt.Pions_No_HGC_Cuts_gtr_p);
    h1_Pi_gtr_dp.Fill(evt.Pions_No_HGC_Cuts_gtr_dp);
    h1_Pi_gtr_xp.Fill(evt.Pions_No_HGC_Cuts_gtr_xp);
    h1_Pi_gtr_yp.Fill(evt.Pions_No_HGC_Cuts_gtr_yp);
    h1_Pi_P_etot.Fill(evt.Pions_No_HGC_Cuts_P_cal_etot);  
    h1_Pi_CTime_ePi_ROC1.Fill(evt.Pions_No_HGC_Cuts_CTime_ePi_ROC1);
...
for evt in Positrons_No_HGC_Cuts:
    #2-D Histograms
    h2_Pos_XyAtCer.Fill(evt.Positrons_No_HGC_Cuts_yAtCer, evt.Positrons_No_HGC_Cuts_xAtCer);
    h2_Pos_Cal_Showers.Fill(evt.Positrons_No_HGC_Cuts_Cal_Shower/evt.Positrons_No_HGC_Cuts_gtr_p, evt.Positrons_No_HGC_Cuts_Cal_Pr_Shower/evt.Positrons_No_HGC_Cuts_gtr_p);
    h2_Pos_XYgtr.Fill(evt.Positrons_No_HGC_Cuts_SHMS_gtr_x, evt.Positrons_No_HGC_Cuts_SHMS_gtr_y);
    # 1-D Histograms
    h1_Pos_hgcer_npeSum.Fill(evt.Positrons_No_HGC_Cuts_SHMS_hgcer_npeSum);
    h1_Pos_aero_npeSum.Fill(evt.Positrons_No_HGC_Cuts_SHMS_aero_npeSum);     
    h1_Pos_xAtCer.Fill(evt.Positrons_No_HGC_Cuts_xAtCer);
    h1_Pos_yAtCer.Fill(evt.Positrons_No_HGC_Cuts_yAtCer);
    h1_Pos_Prshower.Fill(evt.Positrons_No_HGC_Cuts_Cal_Pr_Shower/evt.Positrons_No_HGC_Cuts_gtr_p);
    h1_Pos_Shower.Fill(evt.Positrons_No_HGC_Cuts_Cal_Shower/evt.Positrons_No_HGC_Cuts_gtr_p);
    h1_Pos_Xgtr.Fill(evt.Positrons_No_HGC_Cuts_SHMS_gtr_x);
    h1_Pos_Ygtr.Fill(evt.Positrons_No_HGC_Cuts_SHMS_gtr_y);
    h1_Pos_gtr_beta.Fill(evt.Positrons_No_HGC_Cuts_gtr_beta);    
    h1_Pos_gtr_p.Fill(evt.Positrons_No_HGC_Cuts_gtr_p);
    h1_Pos_gtr_dp.Fill(evt.Positrons_No_HGC_Cuts_gtr_dp);
    h1_Pos_gtr_xp.Fill(evt.Positrons_No_HGC_Cuts_gtr_xp);
    h1_Pos_gtr_yp.Fill(evt.Positrons_No_HGC_Cuts_gtr_yp);
    h1_Pos_P_etot.Fill(evt.Positrons_No_HGC_Cuts_P_cal_etot);  
    #h1_Pi_CTime_ePi_ROC1.Fill(evt.Pions_No_HGC_Cuts_CTime_ePi_ROC1);
...
for evt in Kaons_No_HGC_Cuts:
    h2_Kaons_No_HGC_Cuts_XyAtCer.Fill(evt.Kaons_No_HGC_Cuts_yAtCer, evt.Kaons_No_HGC_Cuts_xAtCer);
    h2_Kaons_No_HGC_Cuts_Cal_Showers.Fill(evt.Kaons_No_HGC_Cuts_Cal_Shower/6.053, evt.Kaons_No_HGC_Cuts_Cal_Pr_Shower/6.053);
    h2_Kaons_No_HGC_Cuts_XYgtr.Fill(evt.Kaons_No_HGC_Cuts_SHMS_gtr_x, evt.Kaons_No_HGC_Cuts_SHMS_gtr_y);
    h1_Kaons_No_HGC_Cuts_hgcer_npeSum.Fill(evt.Kaons_No_HGC_Cuts_SHMS_hgcer_npeSum);
...
for evt in Protons_No_HGC_Cuts:
    h2_Protons_No_HGC_Cuts_XyAtCer.Fill(evt.Protons_No_HGC_Cuts_yAtCer, evt.Protons_No_HGC_Cuts_xAtCer);
    h2_Protons_No_HGC_Cuts_Cal_Showers.Fill(evt.Protons_No_HGC_Cuts_Cal_Shower/6.053, evt.Protons_No_HGC_Cuts_Cal_Pr_Shower/6.053);
    h2_Protons_No_HGC_Cuts_XYgtr.Fill(evt.Protons_No_HGC_Cuts_SHMS_gtr_x, evt.Protons_No_HGC_Cuts_SHMS_gtr_y);
    h1_Protons_No_HGC_Cuts_hgcer_npeSum.Fill(evt.Kaons_No_HGC_Cuts_SHMS_hgcer_npeSum);
