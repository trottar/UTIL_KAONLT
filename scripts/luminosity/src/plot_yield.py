...
# Description:
# ================================================================
# Time-stamp: "2021-09-27 19:52:22 trottar"
# ================================================================
#
...
if "10p6" in inp_name:
    if "1" in inp_name:
        if "LH2" in inp_name.upper():
            target = "LH2"
            inp_f = "%s/UTIL_KAONLT/scripts/luminosity/OUTPUTS/10p6/Lumi_1/LH2/lumi_data_lh2_l1_10p6.csv" % str(REPLAYPATH)
            out_f = "%s/UTIL_KAONLT/scripts/luminosity/OUTPUTS/10p6/Lumi_1/LH2/yield_data_lh2_l1_10p6.csv" % str(REPLAYPATH)
            print("\nGrabbing input...\n%s" % str(inp_f))
        if "C" in inp_name.upper():
            target = "carbon"
            inp_f = "%s/UTIL_KAONLT/scripts/luminosity/OUTPUTS/10p6/Lumi_1/Carbon0p5/lumi_data_c_l1_10p6.csv" % str(REPLAYPATH)
            out_f = "%s/UTIL_KAONLT/scripts/luminosity/OUTPUTS/10p6/Lumi_1/Carbon0p5/yield_data_c_l1_10p6.csv" % str(REPLAYPATH)
            print("\nGrabbing input...\n%s" % str(inp_f))
    elif "2" in inp_name:
        if "LH2" in inp_name.upper():
            target = "LH2"
            inp_f = "%s/UTIL_KAONLT/scripts/luminosity/OUTPUTS/10p6/Lumi_2/LH2/lumi_data_lh2_l2_10p6.csv" % str(REPLAYPATH)
            out_f = "%s/UTIL_KAONLT/scripts/luminosity/OUTPUTS/10p6/Lumi_2/LH2/yield_data_lh2_l2_10p6.csv" % str(REPLAYPATH)
            print("\nGrabbing input...\n%s" % str(inp_f))
        if "C" in inp_name.upper():
            target = "carbon"
            inp_f = "%s/UTIL_KAONLT/scripts/luminosity/OUTPUTS/10p6/Lumi_2/Carbon0p5/lumi_data_c_l2_10p6.csv" % str(REPLAYPATH)
            out_f = "%s/UTIL_KAONLT/scripts/luminosity/OUTPUTS/10p6/Lumi_2/Carbon0p5/yield_data_c_l2_10p6.csv" % str(REPLAYPATH)
            print("\nGrabbing input...\n%s" % str(inp_f))
elif "6p2" in inp_name:
    if "LH2" in inp_name.upper():
        target = "LH2"
        inp_f = "%s/UTIL_KAONLT/scripts/luminosity/OUTPUTS/6p2/Lumi_1/LH2/lumi_data_lh2_l1_6p2.csv" % str(REPLAYPATH)
        out_f = "%s/UTIL_KAONLT/scripts/luminosity/OUTPUTS/6p2/Lumi_1/LH2/yield_data_lh2_l1_6p2.csv" % str(REPLAYPATH)
        print("\nGrabbing input...\n%s" % str(inp_f))
    if "C" in inp_name.upper():
        target = "carbon"
        inp_f = "%s/UTIL_KAONLT/scripts/luminosity/OUTPUTS/6p2/Lumi_1/Carbon0p5/lumi_data_c_l1_6p2.csv" % str(REPLAYPATH)
        out_f = "%s/UTIL_KAONLT/scripts/luminosity/OUTPUTS/6p2/Lumi_1/Carbon0p5/yield_data_c_l1_6p2.csv" % str(REPLAYPATH)
        print("\nGrabbing input...\n%s" % str(inp_f))
elif "8p2" in inp_name:
    if "LH2" in inp_name.upper():
        target = "LH2"
        inp_f = "%s/UTIL_KAONLT/scripts/luminosity/OUTPUTS/8p2/Lumi_1/LH2/lumi_data_lh2_l1_8p2.csv" % str(REPLAYPATH)
        out_f = "%s/UTIL_KAONLT/scripts/luminosity/OUTPUTS/8p2/Lumi_1/LH2/yield_data_lh2_l1_8p2.csv" % str(REPLAYPATH)
        print("\nGrabbing input...\n%s" % str(inp_f))
    if "C" in inp_name.upper():
        target = "carbon"
        inp_f = "%s/UTIL_KAONLT/scripts/luminosity/OUTPUTS/8p2/Lumi_1/Carbon0p5/lumi_data_c_l1_8p2.csv" % str(REPLAYPATH)
        out_f = "%s/UTIL_KAONLT/scripts/luminosity/OUTPUTS/8p2/Lumi_1/Carbon0p5/yield_data_c_l1_8p2.csv" % str(REPLAYPATH)
        print("\nGrabbing input...\n%s" % str(inp_f))
elif inp_name == None:
    target = "carbon"
...
def debug():
    ...
    print("=======================")
    ### Debug prints
    print("TLT",data[["TLT","CPULT_scaler","current"]])
    ###
    print("=======================\n\n")
