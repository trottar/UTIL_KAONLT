...
# ================================================================
# Time-stamp: "2023-05-15 11:06:53 trottar"
# ================================================================
#
...
def plot_yield():
    ...
    residuals = [0.0035852100783795304, -0.003717572456706786, 0.017494091168286263, 0.004362036519797274, 0.006238979788306787, -0.0021022067746221396, 0.016879369384263043]
    #HMS plot track
    plt.subplot(2,3,3)    
    plt.grid(zorder=1)
    plt.xlim(0,70)
    ...
    yield_data["m0_curr_SHMS_track"] = linear_plot(yield_data["current"],yield_data["yieldRel_SHMS_track"],None,yield_data["uncern_yieldRel_SHMS_track"])
