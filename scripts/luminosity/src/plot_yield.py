...
# ================================================================
# Time-stamp: "2023-08-30 16:47:20 trottar"
# ================================================================
#
...
def removeRun(runNum):
    ...
    print("Removing run {} from lumi_data...".format(lumi_data[lumi_data["run number"] == runNum].values))
    lumi_data = lumi_data[lumi_data['run number'] != runNum]
