...
# ================================================================
# Time-stamp: "2022-10-28 12:45:43 trottar"
# ================================================================
#
...
def calc_yield():
    ...
    print ("\n\n\n\n%s%s%s" % (HMS_PS,type(SHMS_PS),COIN_PS) )
    if isinstance(COIN_PS, pandas.core.series.Series):
        ...
        if isinstance(SHMS_PS, pandas.core.series.Series):
            yield_dict.update({"sent_edtm_PS" : makeList("sent_edtm")/SHMS_PS})
        elif isinstance(HMS_PS, pandas.core.series.Series):
