...
# ================================================================
# Time-stamp: "2022-10-28 12:46:18 trottar"
# ================================================================
#
...
def calc_yield():
    ...
    if isinstance(COIN_PS, pd.core.series.Series):
        ...
        if isinstance(SHMS_PS, pd.core.series.Series):
            yield_dict.update({"sent_edtm_PS" : makeList("sent_edtm")/SHMS_PS})
        elif isinstance(HMS_PS, pd.core.series.Series):
