...
# Description:
# ================================================================
# Time-stamp: "2023-05-15 13:10:01 trottar"
# ================================================================
#
...
upper_bounds, lower_bounds = np.tile(all_reg.conf_int(), (len(all_current[:,0]), 0)).T
...
for i, s in enumerate(settingList):
    ...
    upper_bounds, lower_bounds = np.tile(dataDict[s]['reg'].conf_int(), (len(dataDict[s]['x'][:,0]), 0)).T
