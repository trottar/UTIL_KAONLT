...
# Description:
# ================================================================
# Time-stamp: "2023-05-15 13:23:20 trottar"
# ================================================================
#
...
upper_bounds = np.repeat(conf_int[:, 1], len(all_current))
lower_bounds = np.repeat(conf_int[:, 0], len(all_current))
...
for i, s in enumerate(settingList):
    ...
    upper_bounds = np.repeat(conf_int[:, 1], len(dataDict[s]['x']))
    lower_bounds = np.repeat(conf_int[:, 0], len(dataDict[s]['x']))
