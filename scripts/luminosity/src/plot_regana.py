...
# Description:
# ================================================================
# Time-stamp: "2023-05-15 08:06:33 trottar"
# ================================================================
#
...
for s in settingList:
    ...
    upper_bounds = dataDict[s]['y'] + dataDict[s]['yield_errors']
    lower_bounds = dataDict[s]['y'] - dataDict[s]['yield_errors']
    plt.fill_between(X[:,0], upper_bounds[:,0], lower_bounds[:,0], alpha=0.2, label=s)
