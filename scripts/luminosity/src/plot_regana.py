...
# Description:
# ================================================================
# Time-stamp: "2023-05-15 13:15:37 trottar"
# ================================================================
#
...
upper_bounds, lower_bounds = np.tile(all_reg.conf_int(), (int(len(all_current[:,0])/2)+1, 1)).T
...
for i, s in enumerate(settingList):
    ...
    upper_bounds, lower_bounds = np.tile(dataDict[s]['reg'].conf_int(), (int(len(dataDict[s]['x'][:,0])/2)+1, 1)).T
