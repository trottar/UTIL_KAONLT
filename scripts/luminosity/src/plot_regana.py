...
# Description:
# ================================================================
# Time-stamp: "2023-05-15 13:08:19 trottar"
# ================================================================
#
...
#upper_bounds, lower_bounds = np.tile(all_reg.conf_int(), (len(all_current[:,0]), 1)).T
upper_bounds, lower_bounds = np.squeeze(all_reg.conf_int(0.05))
...
for i, s in enumerate(settingList):
    ...
    #upper_bounds, lower_bounds = np.tile(dataDict[s]['reg'].conf_int(), (len(dataDict[s]['x'][:,0]), 1)).T
    upper_bounds, lower_bounds = np.squeeze(dataDict[s]['reg'].conf_int(0.05))
