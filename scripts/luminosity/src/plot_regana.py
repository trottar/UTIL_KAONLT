...
# Description:
# ================================================================
# Time-stamp: "2023-05-15 13:21:09 trottar"
# ================================================================
#
...
upper_bounds, lower_bounds = np.repeat(all_reg.conf_int(), len(all_current), axis=0).T
...
for i, s in enumerate(settingList):
    ...
    upper_bounds, lower_bounds = np.repeat(dataDict[s]['reg'].conf_int(), len(dataDict[s]['x']), axis=0).T
