...
# Description:
# ================================================================
# Time-stamp: "2023-05-15 12:15:24 trottar"
# ================================================================
#
...
for i, s in enumerate(settingList):
    ...
    plt.plot(all_current, all_reg.predict(all_current), linewidth = '5.0', linestyle=':', color='purple')
...
for i, s in enumerate(settingList):
    ...
    plt.plot(dataDict[s]['x'], dataDict[s]['reg'].predict(dataDict[s]['x']), linewidth = '5.0', linestyle=style_list[i], color=color_list[i])
    # print the slope, intercept, and chi-squared value
