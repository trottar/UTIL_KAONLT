...
# Description:
# ================================================================
# Time-stamp: "2023-08-31 13:54:08 trottar"
# ================================================================
#
...
def plot_regress(settingList, momentumList, spec):
    ...
    with PdfPages(SCRIPTPATH+'/luminosity/OUTPUTS/plots/{}_regression_current_{}.pdf'.format(spec.lower(), target)) as pdf:
        ...
        plt.plot([min(run_num_list), max(run_num_list)], [aver_eff_boil, aver_eff_boil], color='r', linestyle='dotted', label='{}: {:.3f}$\pm${:.3f}'.format("$\bar{\epsilon_{boil}}$",aver_eff_boil,uncern_aver_eff_boil))
