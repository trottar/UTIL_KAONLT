...
rootName = "%s/UTIL_KAONLT/ROOTfiles/Analysis/HeeP/%s_%s_%s.root" % (REPLAYPATH, ROOTPrefix, runNum, MaxEvent)     # Input file location and variables taking
...
r = klt.pyRoot()
if spec == "HMS":
    fout = '%s/UTIL_KAONLT/DB/CUTS/run_type/hSing_prod.cuts' % REPLAYPATH
if spec == "SHMS":
    fout = '%s/UTIL_KAONLT/DB/CUTS/run_type/pSing_prod.cuts' % REPLAYPATH
