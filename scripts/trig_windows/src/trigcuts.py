...
# ================================================================
# Time-stamp: "2022-10-28 14:15:37 trottar"
# ================================================================
#
...
def setWindows(runNum):
    ...
    for ps in PS_names:
        if ps == "PS1" or ps == "PS2":
            c_T_coin_pTRIG_SHMS_ROC2_tdcTimeRaw = getBinEdges(T_coin_pTRIG_SHMS_ROC2_tdcTimeRaw,"c_nozero_ptrigSHMS%s" % ps.replace("PS",""),numbins,window)
    
        if ps == "PS3" or ps == "PS4":
            c_T_coin_pTRIG_HMS_ROC1_tdcTimeRaw = getBinEdges(T_coin_pTRIG_HMS_ROC1_tdcTimeRaw,"c_nozero_ptrigHMS%s" % ps.replace("PS",""),numbins,window)

        if ps == "PS5" or ps == "PS6":
            c_T_coin_pTRIG_COIN_ROC1_tdcTimeRaw = getBinEdges(T_coin_pTRIG_COIN_ROC1_tdcTimeRaw,"c_nozero_ptrigCOIN%s" % ps.replace("PS",""),numbins,window)
    ...
    try:
        ...
        c_T_coin_pTRIG_SHMS_ROC2_tdcTimeRaw = [0,0]

    try:
        c_T_coin_pTRIG_HMS_ROC1_tdcTimeRaw
    except NameError:
        c_T_coin_pTRIG_HMS_ROC1_tdcTimeRaw = [0,0]

    try:
        c_T_coin_pTRIG_COIN_ROC1_tdcTimeRaw
    except NameError:
        c_T_coin_pTRIG_COIN_ROC1_tdcTimeRaw = [0,0]        
    ...
    for ps in PS_names:
        if ps == "PS1" or ps == "PS2":
            c_T_coin_pTRIG_SHMS_ROC2_tdcTime = getBinEdges(T_coin_pTRIG_SHMS_ROC2_tdcTime,"c_nozero_ptrigSHMS%s" % ps.replace("PS",""),numbins,window)
    
        if ps == "PS3" or ps == "PS4":
            c_T_coin_pTRIG_HMS_ROC1_tdcTime = getBinEdges(T_coin_pTRIG_HMS_ROC1_tdcTime,"c_nozero_ptrigHMS%s" % ps.replace("PS",""),numbins,window)

        if ps == "PS5" or ps == "PS6":
            c_T_coin_pTRIG_COIN_ROC1_tdcTime = getBinEdges(T_coin_pTRIG_COIN_ROC1_tdcTime,"c_nozero_ptrigCOIN%s" % ps.replace("PS",""),numbins,window)
    ...
    try:
        ...
        c_T_coin_pTRIG_SHMS_ROC2_tdcTime = [0,0]

    try:
        c_T_coin_pTRIG_HMS_ROC1_tdcTime
    except NameError:
        c_T_coin_pTRIG_HMS_ROC1_tdcTime = [0,0]

    try:
        c_T_coin_pTRIG_COIN_ROC1_tdcTime
    except NameError:
        c_T_coin_pTRIG_COIN_ROC1_tdcTime = [0,0]        
