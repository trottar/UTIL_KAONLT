...
# ================================================================
# Time-stamp: "2022-10-28 14:13:44 trottar"
# ================================================================
#
...
def setWindows(runNum):
    ...
    try:
        ...
        c_T_coin_pTRIG_SHMS_ROC2_tdcTimeRaw = [0]

    try:
        c_T_coin_pTRIG_HMS_ROC1_tdcTimeRaw
    except NameError:
        c_T_coin_pTRIG_HMS_ROC1_tdcTimeRaw = [0]

    try:
        c_T_coin_pTRIG_COIN_ROC1_tdcTimeRaw
    except NameError:
        c_T_coin_pTRIG_COIN_ROC1_tdcTimeRaw = [0]        
    ...
    try:
        ...
        c_T_coin_pTRIG_SHMS_ROC2_tdcTime = [0]

    try:
        c_T_coin_pTRIG_HMS_ROC1_tdcTime
    except NameError:
        c_T_coin_pTRIG_HMS_ROC1_tdcTime = [0]

    try:
        c_T_coin_pTRIG_COIN_ROC1_tdcTime
    except NameError:
        c_T_coin_pTRIG_COIN_ROC1_tdcTime = [0]        
