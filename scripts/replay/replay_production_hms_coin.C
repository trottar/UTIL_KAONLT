void replay_production_hms_coin(Int_t RunNumber=0, Int_t MaxEvent=0, Int_t FirstEvent=0) {
  ...
  const char* ROOTFileNamePattern = "UTIL_KAONLT/ROOTfiles/Analysis/KaonLT/KaonLT_hms_coin_replay_production_%d_%d.root";
  ...
  analyzer->PrintReport("UTIL_KAONLT/TEMPLATES/HMS/hstackana_production.template",
			Form("UTIL_KAONLT/REPORT_OUTPUT/HMS/PRODUCTION/KaonLT_replay_hms_coin_production_%d_%d.report", RunNumber, MaxEvent));
