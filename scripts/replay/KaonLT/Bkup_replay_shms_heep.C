void replay_shms_heep (Int_t RunNumber = 0, Int_t MaxEvent = 0) {
  ...
  analyzer->PrintReport("UTIL_KAONLT/config/TEMPLATES/Online_HeePSing.template", Form("UTIL_KAONLT/REPORT_OUTPUT/Analysis/HeeP/Kaon_replay_shms_production_%d_%d.report", RunNumber, MaxEvent)); // optional}
}
