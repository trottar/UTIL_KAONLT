void replay_production_coin (Int_t RunNumber = 0, Int_t MaxEvent = 0) {
  ...
  //analyzer->SetOdefFile("UTIL_KAONLT/config/DEF-files/Full_Replay_Pass2_Coin.def");
  // Define cuts file
  ...
  analyzer->PrintReport("UTIL_KAONLT/config/TEMPLATES/COIN/Online_Coin_Production.template", Form("UTIL_KAONLT/REPORT_OUTPUT/Analysis/KaonLT/Kaon_replay_coin_production_%d_%d.report", RunNumber, MaxEvent)); // optional}
}
