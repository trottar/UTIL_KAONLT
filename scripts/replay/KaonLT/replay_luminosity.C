void replay_luminosity (Int_t RunNumber = 0, Int_t MaxEvent = 0) {
  ...
  const char* ROOTFileNamePattern = "UTIL_KAONLT/ROOTfiles/Analysis/Lumi/Kaon_replay_luminosity_%d_%d.root";
  ...
  analyzer->PrintReport("UTIL_KAONLT/config/TEMPLATES/Online_Lumi.template", Form("UTIL_KAONLT/REPORT_OUTPUT/Analysis/Lumi/Kaon_replay_luminosity_%d_%d.report", RunNumber, MaxEvent)); // optional}
}
