...
{ 
  ...
  if(Hostname.Contains("farm")){
    ...
    ReportFileNameString = Form("/group/c-kaonlt/USERS/${USER}/hallc_replay_lt/UTIL_KAONLTT/REPORT_OUTPUT/COIN/PRODUCTION/PionLT_replay_coin_production_%i_%i.report",RunNumber,MaxEvent);
  }
    ...
    ReportFileNameString = Form("/home/cdaq/hallc-online/hallc_replay_lt/UTIL_KAONLTT/REPORT_OUTPUT/COIN/PRODUCTION/PionLT_replay_coin_production_%i_%i.report",RunNumber,MaxEvent);
  }
    ...
    ReportFileNameString = Form("/home/${USER}/work/JLab/hallc_replay_lt/UTIL_KAONLTT/REPORT_OUTPUT/COIN/PRODUCTION/PionLT_replay_coin_production_%i_%i.report",RunNumber,MaxEvent);
  }
