...
{ 
  ...
  if(Hostname.Contains("farm")){
    ...
    ReportFileNameString = Form("/group/c-pionlt/USERS/${USER}/hallc_replay_lt/UTIL_KAONLTT/REPORT_OUTPUT/COIN/PRODUCTION/PionLT_replay_coin_production_%i_%i.report",RunNumber,MaxEvent);
  }
